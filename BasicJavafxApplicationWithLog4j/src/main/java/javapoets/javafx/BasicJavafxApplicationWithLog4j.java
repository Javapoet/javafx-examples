...
public class BasicJavafxApplicationWithLog4j extends Application {
    ...
    private static final Logger logger = LogManager.getLogger();  // Log4j logger configured in `src\main\resources\log4j2.xml`

    @Override
    public void start(Stage primaryStage) throws Exception {
        logger.debug("start(" + primaryStage + ")");
        logger.info("Basic JavaFX Application with Log4j");
